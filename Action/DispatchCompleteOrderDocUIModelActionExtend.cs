...
{
	public partial class DispatchCompleteOrderDocUIModelAction 
	{
...
this.OnClose_DefaultImpl(sender,e);								
		...
		private void QuickPrint_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.QuickPrint_DefaultImpl(sender,e);								
        } 
		private void WorkTimeData_Extend(object sender, UIActionEventArgs e)
		{
	
			

			//调用模版定义的默认实现方法.如需扩展,请直接在此编程.			
this.WorkTimeData_DefaultImpl(sender,e);								
        } 
