/**************************************************************
 * Description:
 * DispatchCompleteOrderDocUIModelAction.cs
 * Product: U9
 * Co.    : UFIDA Group
...
{
	public partial class DispatchCompleteOrderDocUIModelAction : BaseAction
	{
		private static readonly ILogger logger = LoggerManager.GetLogger(typeof(DispatchCompleteOrderDocUIModelAction));
		//强类型化基类Model属性.
		public new DispatchCompleteOrderDocUIModelModel CurrentModel 
		{
			get {
				return (DispatchCompleteOrderDocUIModelModel)base.CurrentModel;
			}
			set {
		...
		public DispatchCompleteOrderDocUIModelAction(IPart part) : base(part)
		{
		}
		//Model参数的构造,用于测试用例.
		public DispatchCompleteOrderDocUIModelAction(DispatchCompleteOrderDocUIModelModel model) : base(model)
		{
		}
		/// <summary>
		/// Help: 
		...
		/// Help: 
		/// </summary>
		public void QuickPrint(object sender, UIActionEventArgs e)
		{
			//调用基类委托..
			this.InvokeAction(sender,e,this.QuickPrint_Extend);
		}
		private void QuickPrint_DefaultImpl(object sender, UIActionEventArgs e)
		{
		...
		/// Help: 
		/// </summary>
		public void WorkTimeData(object sender, UIActionEventArgs e)
		{
			//调用基类委托..
			this.InvokeAction(sender,e,this.WorkTimeData_Extend);
		}
		private void WorkTimeData_DefaultImpl(object sender, UIActionEventArgs e)
		{
